...
def train(config_manager: ConfigManager) -> None:
    ...
    for base, name in zip(bases, names):
        ...
        for shape in shapes:
            ...
            print("Input shape:", cached_transform["Resize"]["size"])
